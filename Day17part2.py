...
def intcode(cont, finalanswer):
    ...
    while instruction != "99":
        ...
        if instruction == "03":
            ...
            inputvariable = int(finalanswer[y]+finalanswer[y+1])
...
finalanswer = finalanswer.replace("4","52").replace("6","54").replace("8","56").replace("1", "49").replace("2","50").replace(",","44").replace("R","82").replace("L","76").replace("A","65").replace("B","66").replace("C","67").replace("490", "10").replace("550", "52")
